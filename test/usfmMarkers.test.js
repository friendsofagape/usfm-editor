...
function testUsfmWithNumbers(usfm, numbers = [0]) {
    if (usfm.match(/(\\.*?)(#)/)) {
        numbers.forEach((value) => {
            const replaceNumber = value == 0 ? "" : parseInt(value)
            const thisUsfm = usfm.replace(/(\\.*?)(#)/g, `$1${replaceNumber}`)
...
it("preserves ca", () => {
    const usfm = chapter + "\\ca 12\\ca*"
    testUsfm(usfm)
})
it("preserves cp", () => {
    const usfm = chapter + `\\cp cp_content`
    testUsfm(usfm)
})
it("preserves cl", () => {
    const usfm = chapter + `\\cl cl_content`
    testUsfm(usfm)
})
it("preserves cd", () => {
    const usfm = chapter + `\\cd cd_content`
    testUsfm(usfm)
})
it("preserves v", () => {
    const usfm = chapter + `\\v 1 v_content`
    testUsfm(usfm)
})
it("preserves va", () => {
    const usfm = chapter + `\\v 1 \\va 2\\va* Verse 1 with 2 alt`
    testUsfm(usfm)
})
it("preserves vp", () => {
    const usfm =
        chapter + `\\v 1 \\vp 1b\\vp* Verse 1 with published verse character`
    testUsfm(usfm)
})
it("preserves p", () => {
    const usfm = chapter + `\\p p_content`
    testUsfm(usfm)
})
it("preserves m", () => {
    const usfm = chapter + `\\m m_content`
    testUsfm(usfm)
})
it("preserves po", () => {
    const usfm = chapter + `\\po po_content`
    testUsfm(usfm)
})
it("preserves pr", () => {
    const usfm = chapter + `\\pr pr_content`
    testUsfm(usfm)
})
it("preserves cls", () => {
    const usfm = chapter + `\\cls cls_content`
    testUsfm(usfm)
})
it("preserves pmo", () => {
    const usfm = chapter + `\\pmo pmo_content`
    testUsfm(usfm)
})
it("preserves pm", () => {
    const usfm = chapter + `\\pm pm_content`
    testUsfm(usfm)
})
it("preserves pmc", () => {
    const usfm = chapter + `\\pmc pmc_content`
    testUsfm(usfm)
})
it("preserves pmr", () => {
    const usfm = chapter + `\\pmr pmr_content`
    testUsfm(usfm)
})
it("preserves pi", () => {
    const usfm = chapter + `\\pi# pi_content`
    testUsfmWithNumbers(usfm, [0, 1, 2, 3])
})
it("preserves pc", () => {
    const usfm = chapter + `\\pc pc_content`
    testUsfm(usfm)
})
it("preserves ph", () => {
    const usfm = chapter + `\\ph# ph#_content`
    testUsfmWithNumbers(usfm, [0, 1, 2, 3])
})
it("preserves mi", () => {
    const usfm = chapter + `\\mi mi_content`
    testUsfm(usfm)
})
it("preserves nb", () => {
    const usfm = chapter + `\\nb`
...
it("preserves q", () => {
    const usfm = chapter + `\\q# q_content`
    testUsfmWithNumbers(usfm, [0, 1, 2, 3, 4])
})
it("preserves qc", () => {
    const usfm = chapter + `\\qc qc_content`
    testUsfm(usfm)
})
it("preserves qr", () => {
    const usfm = chapter + `\\qr qr_content`
    testUsfm(usfm)
})
it("preserves qs", () => {
    const usfm = chapter + `\\q Test \\qs qs_content\\qs* Test`
    testUsfm(usfm)
})
it("preserves qa", () => {
    const usfm = chapter + `\\qa qa_content`
    testUsfm(usfm)
})
it("preserves qac", () => {
    const usfm = chapter + `\\v 1 Test \\qac qac_content\\qac* Test`
    testUsfm(usfm)
})
it("preserves qm", () => {
    const usfm = chapter + `\\qm# qm_content`
    testUsfmWithNumbers(usfm, [0, 1, 2, 3])
})
it("preserves qd", () => {
    const usfm = chapter + `\\qd qd_content`
    testUsfm(usfm)
})
it("preserves b", () => {
    const usfm = chapter + `\\b`
    testUsfm(usfm)
})
it("preserves mt", () => {
    const usfm = chapter + `\\mt# mt_content`
    testUsfmWithNumbers(usfm, [0, 1, 2, 3, 4])
})
it("preserves mte", () => {
    const usfm = chapter + `\\mte# mte_content`
    testUsfmWithNumbers(usfm, [0, 1, 2])
})
it("preserves ms", () => {
    const usfm = chapter + `\\ms# ms_content`
    testUsfmWithNumbers(usfm, [0, 1, 2, 3])
})
it("preserves mr", () => {
    const usfm = chapter + `\\mr mr_content`
    testUsfm(usfm)
})
it("preserves s", () => {
    const usfm = chapter + `\\s# s#_content`
    testUsfmWithNumbers(usfm, [0, 1, 2, 3, 4])
})
// s5 is given special treatment since we render it as a horizontal rule.
it("preserves s5", () => {
    const usfm = chapter + `\\s5`
    testUsfm(usfm)
})
it("preserves sr", () => {
    const usfm = chapter + `\\sr sr_content`
    testUsfm(usfm)
})
it("preserves r", () => {
    const usfm = chapter + `\\r r_content`
    testUsfm(usfm)
})
it("preserves rq", () => {
    const usfm = chapter + `\\rq rq_content\\rq*`
    testUsfm(usfm)
})
it("preserves sp", () => {
    const usfm = chapter + `\\sp sp_content`
    testUsfm(usfm)
})
it("preserves d", () => {
    const usfm = chapter + `\\d d_content`
    testUsfm(usfm)
})
it("preserves sd", () => {
    const usfm = chapter + `\\sd#`
    testUsfmWithNumbers(usfm, [0, 1, 2, 3, 4])
})
it("preserves tr", () => {
    const usfm = chapter + `\\tr tr_content`
    testUsfm(usfm)
})
it("preserves lh", () => {
    const usfm = chapter + `\\lh lh_content`
    testUsfm(usfm)
})
/**
...
it.skip("preserves unnumbered li", () => {
    const usfm = chapter + `\\li li_content\\li*`
    testUsfm(usfm)
})
it("preserves numbered li", () => {
    const usfm = chapter + `\\li# li_content`
    testUsfmWithNumbers(usfm, [1, 2, 3, 4])
})
it("preserves lf", () => {
    const usfm = chapter + `\\lf lf_content`
    testUsfm(usfm)
})
it("preserves lim", () => {
    const usfm = chapter + `\\lim# lim_content`
    testUsfmWithNumbers(usfm, [0, 1, 2, 3, 4])
})
it("preserves litl", () => {
    const usfm = chapter + `\\lim1\n` + `\\v 1 Test \\litl litl_content\\litl*`
    testUsfm(usfm)
})
it("preserves lik & liv", () => {
    const usfm =
        chapter + `\\li1 \\lik lik_content\\lik* \\liv# liv_content\\liv#*`
...
it("preserves tr and mixed th and thr", () => {
    const usfm = chapter + `\\tr \\th1 Day \\th2 Tribe \\thr3 Leader`
    testUsfm(usfm)
})
/**
...
it.skip("preserves th column spanning", () => {
    const usfm = chapter + `\\tr \\th1-2 Day \\th3 Tribe \\th4-5 Leader`
    testUsfm(usfm)
})
it.skip("preserves thr column spanning", () => {
    const usfm = chapter + `\\tr \\thr1-2 Day \\thr3 Tribe \\thr4-5 Leader`
    testUsfm(usfm)
})
it.skip("preserves tc column spanning", () => {
    const usfm = chapter + `\\tr \\tc1-2 Day \\tc3 Tribe \\tc4-5 Leader`
    testUsfm(usfm)
})
it.skip("preserves tcr column spanning", () => {
    const usfm = chapter + `\\tr \\tcr1-2 Day \\tcr3 Tribe \\tcr4-5 Leader`
    testUsfm(usfm)
})
...
it("preserves qt", () => {
    const usfm = chapter + `\\p Test \\qt qt_content\\qt* Test`
    testUsfm(usfm)
})
it("preserves nd", () => {
    const usfm = chapter + `\\p Test \\nd nd_content\\nd* Test`
    testUsfm(usfm)
})
it("preserves nested nd", () => {
    const usfm1 =
        chapter + `\\p Test \\bk book of the \\+nd Lord\\+nd*\\bk* Test`
    testUsfm(usfm1)
    const usfm2 =
        chapter +
...
it("preserves tl", () => {
    const usfm = chapter + `\\p Test \\tl tl_content\\tl* Test`
    testUsfm(usfm)
})
it("preserves dc", () => {
    const usfm = chapter + `\\p Test \\dc dc_content\\dc* Test`
    testUsfm(usfm)
})
it("preserves bk", () => {
    const usfm = chapter + `\\p Test \\bk bk_content\\bk* Test`
    testUsfm(usfm)
})
it("preserves sig", () => {
    const usfm = chapter + `\\p Test \\sig sig_content\\sig* Test`
    testUsfm(usfm)
})
it("preserves pn", () => {
    const usfm = chapter + `\\p Test \\pn pn_content\\pn* Test`
    testUsfm(usfm)
})
it("preserves png", () => {
    const usfm = chapter + `\\p Test \\png png_content\\png* Test`
    testUsfm(usfm)
})
it("preserves wj", () => {
    const usfm = chapter + `\\p Test \\wj wj_content\\wj* Test`
    testUsfm(usfm)
})
it("preserves k", () => {
    const usfm = chapter + `\\p Test \\k k_content\\k* Test`
    testUsfm(usfm)
})
it("preserves sls", () => {
    const usfm = chapter + `\\p Test \\sls sls_content\\sls* Test`
    testUsfm(usfm)
})
it("preserves ord", () => {
    const usfm = chapter + `\\p Test \\ord ord_content\\ord* Test`
    testUsfm(usfm)
})
it("preserves add", () => {
    const usfm = chapter + `\\p Test \\add add_content\\add* Test`
    testUsfm(usfm)
})
/**
...
it.skip("preserves addpn", () => {
    const usfm = chapter + `\\p Test \\addpn addpn_content\\addpn* Test`
    testUsfm(usfm)
})
it("preserves lit", () => {
    const usfm = chapter + `\\lit lit_content`
    testUsfm(usfm)
})
it("preserves no", () => {
    const usfm = chapter + `\\s Test \\no no_content\\no* Test`
    testUsfm(usfm)
})
it("preserves it", () => {
    const usfm = chapter + `\\p Test \\it it_content\\it* Test`
    testUsfm(usfm)
})
it("preserves bd", () => {
    const usfm = chapter + `\\p Test \\bd bd_content\\bd* Test`
    testUsfm(usfm)
})
it("preserves bdit", () => {
    const usfm = chapter + `\\p Test \\bdit bdit_content\\bdit* Test`
    testUsfm(usfm)
})
it("preserves em", () => {
    const usfm = chapter + `\\p Test \\em em_content\\em* Test`
    testUsfm(usfm)
})
it("preserves sc", () => {
    const usfm = chapter + `\\p Test \\sc sc_content\\sc* Test`
    testUsfm(usfm)
})
it("preserves sup", () => {
    const usfm = chapter + `\\p Test \\sup sup_content\\sup* Test`
    testUsfm(usfm)
})
it("preserves pb", () => {
    const usfm = chapter + `\\pb`
    testUsfm(usfm)
})
it("preserves v //", () => {
    const usfm = chapter + `\\v 15 Space // between`
    testUsfm(usfm)
})
it("preserves v ~", () => {
    const usfm = chapter + `\\v 16 Space~nbsp`
    testUsfm(usfm)
})
it("preserves fig", () => {
    const usfm =
...
it("preserves pro", () => {
    const usfm = chapter + `\\p Test \\pro pro_content\\pro* Test`
    testUsfm(usfm)
})
it("preserves rb", () => {
    const usfm1 = chapter + `\\p Test \\rb BB|gloss="gg:gg"\\rb* Test`
    testUsfm(usfm1)
    const usfm2 = chapter + `\\p Test \\rb BB|"gg:gg"\\rb* Test`
    testUsfm(usfm2)
    const usfm3 = chapter + `\\p Test \\rb BBBB|"g1::g3:"\\rb* Test`
    testUsfm(usfm3)
})
/**
...
it("preserves wh", () => {
    const usfm = chapter + `\\p Test \\wh wh_content\\wh* Test`
    testUsfm(usfm)
})
it("preserves wg", () => {
    const usfm = chapter + `\\p Test \\wg wg_content\\wg* Test`
    testUsfm(usfm)
})
it("preserves wa", () => {
    const usfm = chapter + `\\p Test \\wa wa_content\\wa* Test`
    testUsfm(usfm)
})
it("preserves ndx", () => {
    const usfm = chapter + `\\p Test \\ndx ndx_content\\ndx* Test`
...
it("preserves periph", () => {
    const usfm = chapter + `\\periph periph_content`
    testUsfm(usfm)
})
/**
...
it.skip("preserves qt-s", () => {
    const usfm = chapter + `\\v 17 Test \\qt-s qt-s_content \\qt-e`
    testUsfm(usfm)
})
it.skip("preserves ts-s", () => {
    const usfm = chapter + `\\v 18 Test \\ts-s ts-s_content \\ts-e`
    testUsfm(usfm)
})
