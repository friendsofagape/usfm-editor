...
export const UsfmContainer = ({
    title,
    usfm,
}: UsfmContainerProps): JSX.Element => {
    return (
        <div>
            <h2>{title}</h2>
...
export const InputUsfm = ({ usfm }: UsfmProps): JSX.Element => {
    return <UsfmContainer title={"Input USFM"} usfm={usfm} />
}
InputUsfm.propTypes = usfmPropTypes

export const OutputUsfm = ({ usfm }: UsfmProps): JSX.Element => {
    return <UsfmContainer title={"Output USFM"} usfm={usfm} />
}
